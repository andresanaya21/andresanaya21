...
If you mean to use LoxiLb in EC2 instances:
    - Stop Change Source / destination check: In EC2 instance, select Actions->Networking->Change Source / destination check->Source / destination checking and check the Stop box
